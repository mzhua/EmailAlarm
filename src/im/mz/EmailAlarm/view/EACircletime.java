 ...
 */
public class EACircletime extends View {
    ...
    public interface OnTimeChangeListener{
        void onTimeChange(EACircletime myCircletime);
    }

    public EACircletime(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public EACircletime(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
                ...
                switch (msg.what){
                    case 0:
                        if(onTimeChangeListener != null){
                            onTimeChangeListener.onTimeChange(EACircletime.this);
                        }
                        if(mode == 0){
                            countDown();
                        }else{
